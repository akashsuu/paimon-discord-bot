            ...
            case 'enable':
                if (antinukeData.antinuke) {
                    ...
                    const steps = [
                        ...
                        `Checking akashsuu's role position for optimal configuration...`,
                        `Crafting and configuring the akashsuu Impenetrable Power role...`,
                        `Ensuring precise placement of the akashsuu Impenetrable Power role...`,
                    ...
                    if (message.guild.roles.cache.size > 249) {
                        return message.reply(`I Won't Be Able To Create \`akashsuu Impenetrable Power\` Because There Are Already 249 Roles In This Server`);
                    }
                    ...
                    let createdRole = await message.guild.roles.create({
                        ...
                        reason: `akashsuu Role For Unbypassable Setup`,
