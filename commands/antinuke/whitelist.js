    ...
    run: async (client, message, args) => {
        ...
        if (!antinuke) {
            const dissable = client.util.embed().setColor(client.color)
                .setDescription(` ** ${message.guild.name} security settings <a:akashsuu_antinuke_cmd:1180431827438153821>
...
To enable use antinuke enable ** `)
            ...
            const wl = client.util.embed()
                ...
                .addFields([
                    {
                        name: `__**Usage**__`,
                        value: `<:akashsuu_dot_1:1181287240870146139> \`${message.guild.prefix}whitelist @user/id\`\n<:akashsuu_dot_1:1181287240870146139> \`${message.guild.prefix}wl @user\``
                    }
                ])
