...
//const akashsuuPagination = require('./akashsuuPagination'); // Assuming your pagination function is in this file
...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        client.util.AkashsuuPagination(membersList, title, client, message);
    }
};
